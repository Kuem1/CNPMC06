...
<%@include file="css/navbar.css" %>
 <div class="container">
   ...
   <c:forEach items="${Listkn}" var="x" >
    ...
    <a href="UpdateKnGetIdServlet?idkn=${x.idkn}" >Update</a>
    <%String idu = (String)request.getAttribute("idu");
      if(idu == (String) session.getAttribute("user.idu"))
      {%>
    <a href="DeleteKnServlet?idkn=${x.idkn}&idcv=${x.idcv}" >delete</a>	  
      <% }%>
    
    
    </c:forEach>
   </div>
   <a href="InsertKn.jsp?idcv=${idcv}" >Insert</a>
   </div>
 </div>
