...
/**
 * Servlet implementation class GetKinhNghiemByIdServlet
 */
@WebServlet("/GetKinhNghiemByIdServlet")
public class GetKinhNghiemByIdServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetKinhNghiemByIdServlet() {
        super();
